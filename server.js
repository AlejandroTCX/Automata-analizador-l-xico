...
const objAutomat = {
	0: {
		...
		evaluate: (array, i) => {
			...
			if (words.includes(e)) {
				...
				//Division y numeros negativos
				return objAutomat['14']['evaluate'](array, i);
			} else if (e === '-') {
				//Resta y numeros negativos
				return objAutomat['18']['evaluate'](array, i);
			} else if (e === '"') {
				//Cadena de caracteres
				return objAutomat['21']['evaluate'](array, i);
			} else {
				objAutomat['1']['status'];
			}
		},
	...
	4: {
		...
		evaluate: (array, i) => {
			...
			i = i + 1;
			if (numbers.includes(e)) return objAutomat['5']['evaluate'](array, i);
			return objAutomat['19']['evaluate'](array, i);
		},
	},
	5: {
	...
	6: {
		...
		evaluate: (array, i) => {
			...
			i = i + 1;
			if (e === '=') return objAutomat['7']['evaluate'](array, i + 1);
			return objAutomat['19']['evaluate'](array, i + 1);
		},
	},
	7: {
	...
	14: {
		...
		evaluate: (array, i) => {
			...
			i = i + 1;
			if (e === '*') return objAutomat['15']['evaluate'](array, i);
			if (e === '/') return objAutomat['20']['evaluate'](array, i);
			return objAutomat['19']['evaluate'](array, i);
		},
	},
	15: {
	...
	20: {
		...
		evaluate: (array, i) => {
			const e = array[i];
			if (!e) return objAutomat['23']['evaluate'](array, i + 1);
			i = i + 1;
			console.log(e);
			return objAutomat['20']['evaluate'](array, i);
		},
	},
	21: {
		status: false,
		...
		evaluate: (array, i) => {
			...
			if (!e) return objAutomat['15'];
			i = i + 1;
			if (e === '"') return objAutomat['22']['evaluate'](array, i);
			return objAutomat['21']['evaluate'](array, i);
		},
	},
	22: {
